...
const int DEFAULT_EXPIRED_TIME = 2000;              // ms -> 2 sec
const int DEFAULT_KEEP_ALIVE_TIME = 5 * 60 * 1000;  // ms -> 5 min
...
void MimeType::init() {
    ...
    mime[".htm"] = "text/html";
    mime[".icon"] = "image/x-icon";
    mime[".jpg"] = "image/jpeg";
    mime[".png"] = "image/png";
    mime[".txt"] = "text/plain";
    mime[".mp3"] = "audio/mp3";
#define DEFAULT_SUFFIX "default"
    mime[DEFAULT_SUFFIX] = "text/html";
}
